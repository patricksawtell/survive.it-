...
d3.csv("RegionsBC.csv", function (data) {
  d3.json("bc29.topo.json", function (map) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      var regionPopulation = parseFloat(data[i].Population);
      var regionDensity = parseFloat(data[i].Density);
      var regionHospitals = parseFloat(data[i].Hospitals);
      var regionWildlife = parseFloat(data[i].Wildlife);
      var regionBears = parseFloat(data[i].Bears);
      var regionGoats = parseFloat(data[i].Goats);
      var regionCaribou = parseFloat(data[i].Caribou);
      var regionDeer = parseFloat(data[i].Deer);
      //debugger
